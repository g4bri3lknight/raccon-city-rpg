...
export const SEED_LOCATIONS: Record<string, LocationDefinition> = {
  city_outskirts: {
    ...
    nextLocations: ['rpd_station', 'hospital_district', 'cemetery'],
    isBossArea: false,
    shortName: 'Periferia',
    mapRow: 0,
    mapCol: 0,
  ...
  rpd_station: {
    ...
    encounterRate: 35,
    enemyPool: ['zombie', 'zombie_female', 'zombie_dog', 'cerberus_alpha', 'licker', 'chimera'],
    itemPool: [
  ...
  hospital_district: {
    ...
    encounterRate: 45,
    enemyPool: ['zombie_doctor', 'zombie_soldier', 'zombie_dog', 'licker', 'licker_crawler', 'hunter', 'ivy', 'chimera'],
    itemPool: [
    ...
    nextLocations: ['rpd_station', 'laboratory_entrance', 'abandoned_hospital'],
    isBossArea: false,
    shortName: 'Ospedale',
    mapRow: 1,
    mapCol: 1,
  ...
  sewers: {
    ...
    encounterRate: 50,
    enemyPool: ['zombie_dog', 'cerberus_alpha', 'licker', 'licker_smasher', 'hunter', 'g_adult', 'chimera'],
    itemPool: [
    ...
    nextLocations: ['rpd_station', 'laboratory_entrance', 'water_tower'],
    isBossArea: false,
    shortName: 'Fogne',
    mapRow: 2,
    mapCol: -1,
  ...
  laboratory_entrance: {
    ...
    encounterRate: 55,
    enemyPool: ['hunter', 'licker', 'licker_smasher', 'licker_crawler', 'zombie_soldier', 'ivy', 'g_adult', 'licker_alpha'],
    itemPool: [
  ...
  cemetery: {
    id: 'cemetery',
    name: 'Cimitero di Raccoon City',
    description: 'Un cimitero antico avvolto nella nebbia. Le lapidi sono inclinate, le tombe aperte. Il silenzio è rotto solo dal fruscio delle foglie morte e dal lamento del vento tra i cipressi.',
    backgroundImage: '/api/media/image?id=bg_cemetery',
    encounterRate: 35,
    enemyPool: ['zombie', 'zombie_dog', 'zombie', 'cerberus_alpha'],
    itemPool: [
    ...
    nextLocations: ['city_outskirts', 'hospital_district'],
    isBossArea: false,
    shortName: 'Cimitero',
    mapRow: 0,
    mapCol: 1,
    ...
    mapDanger: 1,
    ambientText: [
      'La nebbia avvolge le lapide come un sudario...',
      'Un corvo gracchia dal campanile della cappella.',
      'La terra smossa di una tomba fresca sembra recente.',
      'Una brezza gelida porta l\'odore della decomposizione.',
      'Le ombre tra le tombe sembrano muoversi da sole.',
    ],
    subAreas: [
      { id: 'safe_room', name: 'Safe Room', description: 'Una cripta di famiglia fortunatamente sigillata. L\'unico luogo nel cimitero dove le creature non possono entrare.' },
    ],
    storyEvent: {
      title: 'La Tomba del Custode',
      description: 'Trovate una tomba aperta con una nota scritta col sangue: "Non aprite la cripta della famiglia Viscardi. Quello che è dentro non è morto." La porta della cripta è socchiusa.',
      choices: [
        {
          text: 'Entrare nella cripta',
          outcome: {
            description: 'Scendete le scale di pietra. Trovate un kit medico nascosto tra le bare, ma qualcosa si muove nell\'ombra...',
            receiveItems: [{ itemId: 'first_aid', quantity: 1 }],
            triggerCombat: true,
            combatEnemyIds: ['zombie', 'zombie'],
          },
        ...
        {
          text: 'Allontanarsi con rispetto',
          outcome: {
            description: 'Vi allontanate in silenzio. Trovate un mazzo di erbe cresciute tra le fessure di una lapide.',
            receiveItems: [{ itemId: 'herb_green', quantity: 2 }],
          },
        },
      ],
  ...
  abandoned_hospital: {
    ...
    name: 'Ospedale Abbandonato',
    description: 'Un vecchio ospedale psichiatrico abbandonato da decenni. Le pareti sono coperte di muffa, le finestre sbarrate. Si dice che la Umbrella lo usasse per esperimenti segreti prima del virus T.',
    backgroundImage: '/api/media/image?id=bg_abandoned_hospital',
    encounterRate: 45,
    enemyPool: ['zombie_doctor', 'zombie_dog', 'zombie_doctor', 'hunter', 'licker'],
    itemPool: [
      { itemId: 'bandage', chance: 30, quantity: 1 },
      { itemId: 'herb_green', chance: 25, quantity: 1 },
      { itemId: 'antidote', chance: 20, quantity: 1 },
      { itemId: 'spray', chance: 10, quantity: 1 },
      { itemId: 'fuse', chance: 5, quantity: 1 },
    ],
    nextLocations: ['hospital_district', 'laboratory_entrance'],
    isBossArea: false,
    shortName: 'Osp. Abbandonato',
    mapRow: 2,
    mapCol: 1,
    mapIcon: '🏚️',
    mapDanger: 2,
    lockedLocations: [
      { locationId: 'laboratory_entrance', requiredItemId: 'key_lab', lockedMessage: '🔒 Una porta blindata con il logo Umbrella blocca il passaggio. Serve una tessera magnetica per aprirla.' },
    ],
    ambientText: [
      'Le sedie a rotelle abbandonate si muovono da sole nel corridoio...',
      'Un monitor spento si accende per un istante, mostrando un volto distorto.',
      'Il suono ritmico di un macchinario cardiaco proveniente dal seminterrato.',
      'Graffiti sulle pareti: "NON CREDERETE A QUELLO CHE HANNO FATTO QUI".',
      'Una porta sbatte improvvisamente al vento, rivelando una stanza buia.',
    ],
    subAreas: [
      { id: 'safe_room', name: 'Safe Room', description: 'La vecchia cappella dell\'ospedale, con una porta pesante in legno di quercia. L\'unico luogo con aria pulita e luce naturale.' },
    ],
    storyEvent: {
      title: 'L\'Archivio Segreto',
      description: 'Nell\'ala est dell\'ospedale trovate un archivio sigillato. Sulla porta c\'è un cartello: "REPARTO RICERCA — SOLO PERSONALE AUTORIZZATO." Una chiave d\'ottone è infilata nella toppa.',
      choices: [
        {
          text: 'Aprire l\'archivio',
          outcome: {
            description: 'Dentro trovate file classificati della Umbrella e un fucile a pompa nascosto in un armadietto.',
            receiveItems: [{ itemId: 'shotgun', quantity: 1 }, { itemId: 'ammo_shotgun', quantity: 4 }],
            triggerCombat: true,
            combatEnemyIds: ['hunter'],
          },
        },
        {
          text: 'Non disturbare e proseguire',
          outcome: {
            description: 'Rispettate il sigillo. Trovate un antidoto dimenticato su un carrello medico nel corridoio.',
            receiveItems: [{ itemId: 'antidote', quantity: 2 }],
          },
        },
      ],
    },
  ...
  water_tower: {
    ...
    description: 'Un\'imponente torre idrica industriale che sovrasta la zona industriale. Le condutture arrugginite gocciolano un liquido verdastro. Si dice che la Umbrella usasse il serbatoio per smaltire scorie biologiche.',
    backgroundImage: '/api/media/image?id=bg_water_tower',
    encounterRate: 50,
    enemyPool: ['zombie_dog', 'licker', 'licker_crawler', 'g_adult'],
    itemPool: [
      { itemId: 'ammo_shotgun', chance: 25, quantity: 4 },
      { itemId: 'herb_green', chance: 20, quantity: 1 },
      { itemId: 'ammo_pistol', chance: 20, quantity: 5 },
      { itemId: 'crank_handle', chance: 5, quantity: 1 },
    ],
    nextLocations: ['sewers', 'laboratory_entrance'],
    isBossArea: false,
    shortName: 'Torre Acqua',
    mapRow: 3,
    mapCol: -1,
    mapIcon: '🗼',
    mapDanger: 2,
    lockedLocations: [
      { locationId: 'laboratory_entrance', requiredItemId: 'key_lab', lockedMessage: '🔒 Un passaggio nascosto sotto la torre conduce al laboratorio. Serve una tessera magnetica Umbrella per attivare il pannello.' },
    ],
    ambientText: [
      'Il ronzio metallico delle condutture si amplifica nel silenzio...',
      'Un liquido verdastro gocciola da una valvola rotta.',
      'La scala a chiocciola interna è coperta di ruggine e muschio.',
      'Una creatura si muove nell\'ombra tra le travi metalliche.',
      'Il vento ulula attraverso le aperture della torre come un lamento.',
    ],
    subAreas: [
      { id: 'safe_room', name: 'Safe Room', description: 'La sala di controllo della torre, con una porta blindata anti-allagamento. L\'unico luogo asciutto e sicuro nella struttura.' },
    ],
    storyEvent: {
      title: 'Il Serbatoio Infetto',
      description: 'Alla base della torre trovate un serbatoio di contenimento semi-aperto. All\'interno si vede qualcosa di enorme che si muove nell\'acqua scura. Una scala porta in cima alla torre.',
      choices: [
        {
          text: 'Salire in cima alla torre',
          outcome: {
            description: 'Dalla cima avete una vista panoramica. Trovate munizioni abbandonate in una casseforta dimenticata dai tecnici.',
            receiveItems: [{ itemId: 'ammo_shotgun', quantity: 6 }, { itemId: 'ammo_grenade', quantity: 1 }],
          },
        },
        {
          text: 'Esplorare la base del serbatoio',
          outcome: {
            description: 'Vi avvicinate al serbatoio. L\'acqua si agita violentemente e qualcosa emerge...',
            triggerCombat: true,
            combatEnemyIds: ['g_adult', 'zombie_dog'],
          },
        },
      ],
    },
