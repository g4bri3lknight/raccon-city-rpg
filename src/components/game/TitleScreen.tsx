...
// Default values (used until settings load from DB) — kept GENERIC, not game-specific
const DEFAULTS: Record<string, string> = {
  'titleScreen.umbrellaText':    '',
  'titleScreen.title':           'RPG GAME',
  'titleScreen.subtitle':        '',
  'titleScreen.description':     '',
  'titleScreen.newGameBtn':      'Nuova partita',
  'titleScreen.loadGameBtn':     'Carica partita',
  'titleScreen.warningText':     'Gioco a turni per 1-3 giocatori',
  'titleScreen.umbrellaColor':   '#94a3b8',
  'titleScreen.titleColor':      '#ffffff',
  'titleScreen.titleGlow':       '0 0 40px rgba(148,163,184,0.4), 0 0 80px rgba(148,163,184,0.2), 0 0 120px rgba(148,163,184,0.1)',
  'titleScreen.subtitleColor':   '#94a3b8',
  'titleScreen.overlayOpacity':  '0.7',
  'titleScreen.btnBg':           '#1e293b',
  'titleScreen.btnBorder':       '#334155',
  'titleScreen.btnHoverBg':      '#334155',
  'titleScreen.btnHoverBorder':  '#475569',
  'titleScreen.btnTextColor':    '#e2e8f0',
  'titleScreen.btnGlowHover':    'rgba(100,116,139,0.4)',
};

/**
 * Get a setting value. Once DB settings are loaded, use them as-is (even if empty).
 * Fall back to DEFAULTS only for keys that are completely missing from the DB response.
 */
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 flex flex-col items-center gap-6">
        {/* Upper subtitle (sovratitolo) — only render if configured */}
        ...
        {/* Subtitle — only render if configured */}
        ...
        {/* Description — only render if configured */}
