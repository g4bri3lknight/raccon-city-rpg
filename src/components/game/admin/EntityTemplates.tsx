  ...
  locations: [
    {
      ...
      data: {
        ...
        isBossArea: false,
        bossId: '',
        enemyPool: ['zombie_basic', 'zombie_dog'],
        itemPool: [],
        nextLocations: ['rpd_station'],
        storyEvent: null,
        ambientText: [
          'Il vento porta un tanfo di decomposizione.',
          'Passi pesanti risuonano da qualche parte.',
          'Una vetrina infranta riflette la luce tremolante.',
        ],
        lockedLocations: [],
        subAreas: [],
        mapRow: 0,
    ...
    },
    {
      ...
      data: {
        ...
        isBossArea: false,
        bossId: '',
        enemyPool: ['zombie_basic', 'licker'],
        itemPool: [],
        nextLocations: ['underground_lab'],
        storyEvent: null,
        ambientText: [
          'Un orologio a muro ticchetta in modo sinistro.',
          'Il riflesso dei lampeggianti della polizia stilla sangue.',
          'File e documenti sparsi ovunque sul pavimento.',
        ],
        lockedLocations: [],
        subAreas: [],
        mapRow: 1,
    ...
    },
    {
      ...
      data: {
        ...
        isBossArea: false,
        bossId: '',
        enemyPool: ['hunter', 'licker', 'cerberus'],
        itemPool: [],
        nextLocations: [],
        storyEvent: null,
        ambientText: [
          'Tubi di vetro contengono fluidi verdi luminosi.',
          'Allarmi lampeggiano nel corridoio sterile.',
          'Il ronzio dei generatori copre ogni altro suono.',
        ],
        lockedLocations: [],
        subAreas: [],
        mapRow: 2,
    ...
    },
    {
      ...
      data: {
        ...
        storyEvent: null,
        ambientText: [
          'Un\'atmosfera di calma qui dentro.',
          'Una macchinetta del caffè stilla l\'ultimo caffè.',
          'Il rumore della pioggia si sente in lontananza.',
        ],
        lockedLocations: [],
        subAreas: [],
        mapRow: 1,
