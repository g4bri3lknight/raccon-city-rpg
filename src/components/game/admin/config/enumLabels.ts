...
export const ENUM_LABELS: Record<string, Record<string, { it: string; hint?: string }>> = {
  ...
  roomIcon: {
    ...
    '🏠': { it: '🏠 Casa / Abitazione' },
    '🏢': { it: '🏢 Edificio / Ufficio' },
    '🏛️': { it: '🏛️ Palazzo / Municipio' },
    '🏚️': { it: '🏚️ Edificio Abbandonato' },
    '🔬': { it: '🔬 Laboratorio' },
    '⚗️': { it: '⚗️ Chimica / Reagenti' },
    '🖥️': { it: '🖥️ Server / Computer' },
    '📡': { it: '📡 Radio / Comunicazioni' },
    '⚙️': { it: '⚙️ Meccanica / Caldaia' },
    '🔋': { it: '🔋 Generatore / Energia' },
    '💉': { it: '💉 Infermeria / Ambulatorio' },
    '🏥': { it: '🏥 Ospedale / Ospedale da Campo' },
    '🛏️': { it: '🛏️ Camera da Letto' },
    '🍽️': { it: '🍽️ Mensa / Cucina' },
    '🚿': { it: '🚿 Bagno / Docce' },
    '🪜': { it: '🪜 Scale / Scala' },
    '🛋️': { it: '🛋️ Soggiorno / Sala d\'Attesa' },
    '📦': { it: '📦 Magazzino / Deposito' },
    '🗄️': { it: '🗄️ Archivio' },
    '🧳': { it: '🧳 Armadietto / Bagagli' },
    '🔒': { it: '🔒 Chiuso a Chiave' },
    '🗝️': { it: '🗝️ Stanza delle Chiavi' },
    '💀': { it: '💀 Pericolo / Morte' },
    '🧟': { it: '🧟 Infestazione Zombie' },
    '🔥': { it: '🔥 Incendio' },
    '☢️': { it: '☢️ Radioattivo / Tossico' },
    '⚡': { it: '⚡ Elettrico / Cortocircuito' },
    '💧': { it: '💧 Allagato / Acqua' },
    '❄️': { it: '❄️ Congelato / Ghiaccio' },
    '💎': { it: '💎 Tesoro / Bottino' },
    '🏪': { it: '🏪 Negozio / Mercato' },
    '⛪': { it: '⛪ Chiesa / Cappella' },
    '🕯️': { it: '🕯️ Buio / Candles' },
    '🌿': { it: '🌿 Giardino / Serra' },
    '🌲': { it: '🌲 Foresta / Esterno' },
    '🕳️': { it: '🕳️ Bucho / Voragine' },
    '🌉': { it: '🌉 Ponte / Passerella' },
    '🖼️': { it: '🖼️ Galleria / Mostra' },
    '🎭': { it: '🎭 Teatro / Sala Eventi' },
    '🏊': { it: '🏊 Piscina' },
    '🎮': { it: '🎮 Sala Controllo' },
    '💡': { it: '💡 Illuminazione' },
    '🗺️': { it: '🗺️ Mappa / Cartografia' },
    '📜': { it: '📜 Biblioteca / Documenti' },
    '🚗': { it: '🚗 Garage / Parcheggio' },
    '🛗': { it: '🛗 Ascensore' },
    '🚪‍↔️': { it: '🚪‍↔️ Doppia Porta' },
    '🪤': { it: '🪤 Trappola' },
    '🕷️': { it: '🕷️ Ragnatele / Buio' },
    '🦇': { it: '🦇 Cantina / Sottosuolo' },
    '👾': { it: '👾 Presenza Nemica' },
    '👤': { it: '👤 Sopravvissuto / Rifugio' },
    '🛡️': { it: '🛡️ Zona Sicura' },
    '⚠️': { it: '⚠️ Zona Pericolosa' },
    '🚨': { it: '🚨 Allarme' },
    '🔑': { it: '🔑 Porta Chiave' },
    '🗡️': { it: '🗡️ Armeria' },
    '🧪': { it: '🧪 Sperimentazione' },
    '🧬': { it: '🧬 Genetica / Biotest' },
    '📉': { it: '📉 Oblò / Osservatorio' },
    '🪟': { it: '🪟 Finestra / Vetro' },
    '🧹': { it: '🧹 Ripostiglio / Pulizie' },
  },
  doorState: {
    open:          { it: '🟢 Sbloccata' },
