...
export const FIELD_MAP: Record<TabId, FieldDef[]> = {
  ...
  characters: [
    ...
    { key: 'archetype', label: 'Archetipo', type: 'select', options: ['tank', 'healer', 'dps', 'control', 'survivor', 'custom'], enumGroup: 'archetype' },
    ...
    { key: 'def', label: 'DEF', type: 'number', defaultValue: 10 },
    { key: 'spd', label: 'SPD', type: 'number', defaultValue: 10 },
    { key: 'specialName', label: 'Abilità 1', type: 'entity-search', entitySearchEndpoint: '/api/admin/specials', entitySearchLabelKey: 'name', entityIconKey: 'icon', placeholder: 'es: Barricata', colSpan: 2 },
    { key: 'special2Name', label: 'Abilità 2', type: 'entity-search', entitySearchEndpoint: '/api/admin/specials', entitySearchLabelKey: 'name', entityIconKey: 'icon', placeholder: 'es: Immolazione', colSpan: 2 },
  ...
  rooms: [
    ...
    { key: 'lockedRooms', label: 'Stanze Bloccate', type: 'locked-locs', colSpan: 3 },
    { key: 'enemyPool', label: 'Pool Nemici', type: 'entity-tag-editor', entitySearchEndpoint: '/api/admin/enemies', entitySearchLabelKey: 'name', entityIconKey: 'icon', placeholder: 'Cerca e seleziona nemici...', colSpan: 3 },
    { key: 'itemPool', label: 'Pool Oggetti', type: 'item-pool', colSpan: 3 },
