...
export const FIELD_MAP: Record<TabId, FieldDef[]> = {
  ...
  rooms: [
    ...
    { key: 'travelCost', label: "Costo Viaggio (turni)", type: 'number', defaultValue: 1, helpText: "Turni spesi per viaggiare verso questa stanza da un'altra location. Usato per calcolare il costo di attraversamento tra location." },
