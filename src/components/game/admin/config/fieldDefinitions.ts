...
export const FIELD_MAP: Record<TabId, FieldDef[]> = {
  ...
  npcs: [
    ...
    { key: 'questId', label: 'Quest ID', type: 'entity-search', entitySearchEndpoint: '/api/admin/quest-chains', entitySearchLabelKey: 'name', placeholder: 'es: quest_marco_firstaid', helpText: 'La missione che questo NPC assegna al giocatore', colSpan: 2 },
  ...
  locations: [
    ...
    { key: 'encounterRate', label: 'Costo Viaggio', type: 'number', defaultValue: 0, helpText: 'Valore >40 = costa 2 turni viaggiare qui, altrimenti 1 turno.' },
    ...
    { key: 'mapDanger', label: 'Pericolo Mappa', type: 'select', options: ['-1', '0', '1', '2', '3'], enumGroup: 'mapDangerLevel', defaultValue: '-1', helpText: 'Solo visivo. Livello di pericolo mostrato sul nodo mappa.' },
    { key: 'shortName', label: 'Nome Breve', type: 'text', placeholder: 'es: Periferia', helpText: 'Nome abbreviato mostrato sul nodo mappa (opzionale)' },
  ...
  rooms: [
    ...
    { key: 'icon', label: 'Icona', type: 'select', enumGroup: 'roomIcon', options: ['🚪','🏠','🏢','🏛️','🏚️','🔬','⚗️','🖥️','📡','⚙️','🔋','💉','🏥','🛏️','🍽️','🚿','🪜','🛋️','📦','🗄️','🧳','🔒','🗝️','💀','🧟','🔥','☢️','⚡','💧','❄️','💎','🏪','⛪','🕯️','🌿','🌲','🕳️','🌉','🖼️','🎭','🏊','🎮','💡','🗺️','📜','🚗','🛗','🚪‍↔️','🪤','🕷️','🦇','👾','👤','🛡️','⚠️','🚨','🔑','🗡️','🧪','🧬','📉','🪟','🧹'], defaultValue: '🚪' },
  ...
  'quest-chains': [
    ...
    { key: 'prerequisiteQuestId', label: 'Prerequisito Missione ID', type: 'entity-search', entitySearchEndpoint: '/api/admin/quest-chains', entitySearchLabelKey: 'name', placeholder: 'es: prev_quest_id', colSpan: 2, helpText: 'Missione che deve essere completata prima (solo per catene a step singolo)' },
