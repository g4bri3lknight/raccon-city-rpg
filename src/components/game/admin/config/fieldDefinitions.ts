...
export const FIELD_MAP: Record<TabId, FieldDef[]> = {
  items: [
    ...
    { key: 'rarity', label: 'Rarità', type: 'select', options: ['common', 'uncommon', 'rare', 'epic', 'legendary'], enumGroup: 'rarity' },
  ...
  events: [
    ...
    { key: 'description', label: 'Descrizione', type: 'textarea', colSpan: 3 },
    { key: 'icon', label: 'Icona', type: 'text', placeholder: 'es: 🌑' },
    { key: 'type', label: 'Tipo', type: 'select', options: ['blackout', 'alarm', 'collapse', 'lockdown', 'gas_leak', 'fire', 'nemesis_invasion', 'horde'], enumGroup: 'eventType' },
  ...
  documents: [
    ...
    { key: 'icon', label: 'Icona', type: 'text', placeholder: 'es: 📝' },
    { key: 'rarity', label: 'Rarità', type: 'select', options: ['common', 'uncommon', 'rare', 'epic', 'legendary'], enumGroup: 'rarity', defaultValue: 'common' },
  ...
  archetypes: [
    { key: 'name', label: 'Nome', type: 'text', required: true, placeholder: 'es: Guerriero, Mago, Tank' },
    { key: 'displayName', label: 'Nome Visualizzato', type: 'text', placeholder: 'es: Guerriero Vichingo' },
    { key: 'description', label: 'Descrizione', type: 'textarea', placeholder: 'Descrizione dell\'archetipo...', colSpan: 3 },
    { key: 'maxHp', label: 'HP Massimo', type: 'number', defaultValue: 100 },
    { key: 'atk', label: 'ATK', type: 'number', defaultValue: 15 },
    { key: 'def', label: 'DEF', type: 'number', defaultValue: 10 },
    { key: 'spd', label: 'SPD', type: 'number', defaultValue: 10 },
    { key: 'hpGrowth', label: 'Crescita HP', type: 'number', defaultValue: 1.0, helpText: 'Moltiplicatore HP per livello' },
    { key: 'atkGrowth', label: 'Crescita ATK', type: 'number', defaultValue: 1.0, helpText: 'Moltiplicatore ATK per livello' },
    { key: 'defGrowth', label: 'Crescita DEF', type: 'number', defaultValue: 1.0, helpText: 'Moltiplicatore DEF per livello' },
    { key: 'spdGrowth', label: 'Crescita SPD', type: 'number', defaultValue: 1.0, helpText: 'Moltiplicatore SPD per livello' },
    { key: 'specialId', label: 'Abilità Speciale', type: 'entity-search', entitySearchEndpoint: '/api/admin/specials', entitySearchLabelKey: 'name', entityIconKey: 'icon', placeholder: 'Cerca abilità...', colSpan: 2 },
    { key: 'special2Id', label: 'Abilità Speciale 2', type: 'entity-search', entitySearchEndpoint: '/api/admin/specials', entitySearchLabelKey: 'name', entityIconKey: 'icon', placeholder: 'Cerca abilità...', colSpan: 2 },
    { key: 'passiveName', label: 'Passiva Nome', type: 'text', placeholder: 'es: Rigenerazione' },
    { key: 'passiveDescription', label: 'Passiva Descrizione', type: 'textarea', placeholder: 'Descrizione dell\'abilità passiva...', colSpan: 3 },
    { key: 'startingItems', label: 'Oggetti Iniziali', type: 'starting-items', colSpan: 3, helpText: 'Oggetti che i personaggi di questo archetipo ricevono all\'inizio del gioco.' },
    { key: 'portraitEmoji', label: 'Emoji Ritratto', type: 'text', placeholder: 'es: ⚔️', defaultValue: '⚔️' },
  ...
  characters: [
    ...
    { key: 'archetypeId', label: 'Archetipo', type: 'entity-search', entitySearchEndpoint: '/api/admin/archetypes', entitySearchLabelKey: 'name', entityIconKey: 'portraitEmoji', placeholder: 'Lascia vuoto per personaggio custom...', colSpan: 2, helpText: 'Se selezionato, il personaggio erediterà statistiche, abilità e passiva dall\'archetipo. Lascia vuoto per un personaggio personalizzato.' },
    ...
    { key: 'maxHp', label: 'HP Massimo', type: 'number', defaultValue: 100, helpText: 'Solo per custom: altrimenti ereditato dall\'archetipo' },
    { key: 'atk', label: 'ATK', type: 'number', defaultValue: 10, helpText: 'Solo per custom: altrimenti ereditato dall\'archetipo' },
    { key: 'def', label: 'DEF', type: 'number', defaultValue: 10, helpText: 'Solo per custom: altrimenti ereditato dall\'archetipo' },
    { key: 'spd', label: 'SPD', type: 'number', defaultValue: 10, helpText: 'Solo per custom: altrimenti ereditato dall\'archetipo' },
    { key: 'specialName', label: 'Abilità 1 Nome', type: 'text', placeholder: 'es: Barricata', helpText: 'Solo per custom: nome abilità speciale' },
    { key: 'specialDescription', label: 'Abilità 1 Descrizione', type: 'textarea', placeholder: 'Descrizione abilità...', colSpan: 3, helpText: 'Solo per custom' },
    { key: 'specialCost', label: 'Abilità 1 Costo', type: 'number', defaultValue: 15, helpText: 'Solo per custom: costo in turni' },
    { key: 'special2Name', label: 'Abilità 2 Nome', type: 'text', placeholder: 'es: Sfuriata', helpText: 'Solo per custom: nome abilità speciale' },
    { key: 'special2Description', label: 'Abilità 2 Descrizione', type: 'textarea', placeholder: 'Descrizione abilità...', colSpan: 3, helpText: 'Solo per custom' },
    { key: 'special2Cost', label: 'Abilità 2 Costo', type: 'number', defaultValue: 15, helpText: 'Solo per custom: costo in turni' },
    { key: 'passiveDescription', label: 'Passiva', type: 'textarea', placeholder: 'Descrizione abilità passiva...', colSpan: 3, helpText: 'Solo per custom: altrimenti ereditata dall\'archetipo' },
    { key: 'portraitEmoji', label: 'Emoji Ritratto', type: 'text', placeholder: 'es: 🛡️' },
    { key: 'startingItems', label: 'Oggetti Iniziali', type: 'starting-items', colSpan: 3, helpText: 'Oggetti che il personaggio ha all\'inizio del gioco. Se vuoto, eredita dall\'archetipo.' },
    { key: 'sortOrder', label: 'Ordine', type: 'number', defaultValue: 0, helpText: 'Ordine di visualizzazione nella schermata selezione personaggi' },
  ],
  locations: [
    ...
    { key: 'encounterRate', label: 'Prob. Incontri %', type: 'number', defaultValue: 0, helpText: 'Probabilità (0-100) di incontro nemico per azione nella location' },
    ...
    { key: 'docChance', label: 'Prob. Documento %', type: 'number', placeholder: '35 (default)', helpText: 'Probabilità (0-100) di trovare un documento quando la ricerca ha successo. Default: 35%.' },
    { key: 'searchMax', label: 'Max Ricerche', type: 'number', placeholder: 'Random 1-3', helpText: 'Max ricerche per location. Vuoto = random 1-3, 0 = illimitate.' },
    { key: 'isBossArea', label: 'Area Boss', type: 'boolean', defaultValue: false, helpText: 'Se true, questa location contiene un boss finale' },
    ...
    { key: 'enemyPool', label: 'Pool Nemici', type: 'entity-tag-editor', entitySearchEndpoint: '/api/admin/enemies', entitySearchLabelKey: 'name', entityIconKey: 'icon', placeholder: 'Cerca e seleziona nemici...', colSpan: 3, helpText: 'Nemici che possono essere incontrati in questa location (le stanze possono sovrascrivere)' },
    { key: 'itemPool', label: 'Pool Oggetti', type: 'item-pool', colSpan: 3, helpText: 'Oggetti trovabili nella location (le stanze possono avere propri pool)' },
    { key: 'nextLocations', label: 'Location Uscite', type: 'entity-tag-editor', entitySearchEndpoint: '/api/admin/locations', entitySearchLabelKey: 'name', placeholder: 'Cerca e seleziona location...', colSpan: 3, helpText: 'Location raggiungibili da qui' },
    { key: 'lockedLocations', label: 'Location Bloccate', type: 'locked-locs', colSpan: 3, helpText: 'Location che richiedono un oggetto specifico per essere sbloccate' },
    { key: 'storyEvent', label: 'Evento Storia', type: 'story-event', colSpan: 3, helpText: 'Evento narrativo opzionale per questa location' },
    { key: 'ambientText', label: 'Testi Ambientali', type: 'text-list', colSpan: 3, helpText: 'Testi descrittivi mostrati casualmente durante l\'esplorazione' },
    { key: 'mapRow', label: 'Riga Mappa', type: 'number', placeholder: '0-4', helpText: 'Posizione verticale sulla mappa (0 = in alto). Lascia vuoto per nascondere.' },
    ...
    { key: 'mapDanger', label: 'Pericolo Mappa', type: 'select', options: ['-1', '0', '1', '2', '3'], enumGroup: 'mapDangerLevel', defaultValue: '-1', helpText: 'ⓘ Solo visivo. "Automatico" calcola dal pool nemici.' },
    { key: 'sortOrder', label: 'Ordine', type: 'number', defaultValue: 0, helpText: 'Ordine di visualizzazione' },
  ],
  rooms: [
    { key: 'id', label: 'ID', type: 'text', required: true, placeholder: 'es: rpd_main_hall' },
    ...
    { key: 'name', label: 'Nome', type: 'text', required: true, placeholder: 'es: Atri Principale' },
    { key: 'description', label: 'Descrizione', type: 'textarea', placeholder: 'Descrizione della stanza', colSpan: 3 },
    { key: 'type', label: 'Tipo', type: 'select', options: ['normal', 'safe_room', 'boss_room', 'secret', 'shop', 'puzzle', 'corridor'], enumGroup: 'roomType' },
    { key: 'icon', label: 'Icona', type: 'text', placeholder: 'es: 🚪' },
    { key: 'orientation', label: 'Orientamento', type: 'select', options: ['auto', 'horizontal', 'vertical'], enumGroup: 'roomOrientation', helpText: 'Solo per corridoi: "auto" lo deduce dai collegamenti. Orizzontale = rettangolo largo, Verticale = rettangolo alto.' },
    { key: 'nextRooms', label: 'Uscite Stanze', type: 'entity-tag-editor', entitySearchEndpoint: '/api/admin/rooms', entitySearchLabelKey: 'name', placeholder: 'Cerca e seleziona stanze...', colSpan: 3 },
    ...
    { key: 'searchChance', label: 'Prob. Ricerca %', type: 'number', placeholder: '0-100', helpText: 'Probabilità (0-100) di trovare qualcosa. Vuoto = usa il default della location.' },
    { key: 'searchMax', label: 'Max Ricerche', type: 'number', placeholder: 'Vuoto = default location', helpText: 'Max ricerche per stanza. Vuoto = usa il default della location.' },
    { key: 'npcIds', label: 'NPC', type: 'entity-tag-editor', entitySearchEndpoint: '/api/admin/npcs', entitySearchLabelKey: 'name', entityIconKey: 'portrait', placeholder: 'Cerca e seleziona NPC...', colSpan: 3 },
    ...
    { key: 'mapCol', label: 'Colonna Mappa', type: 'number', placeholder: '-1, 0, 1', helpText: 'Posizione orizzontale: -1 = sinistra, 0 = centro, 1 = destra' },
    { key: 'sortOrder', label: 'Ordine', type: 'number', defaultValue: 0, helpText: 'Ordine di visualizzazione nella lista stanze (non usato dal motore di gioco)' },
  ],
  specials: [
  ...
  recipes: [
    ...
    { key: 'pointCost', label: 'Costo Punti Craft', type: 'number', placeholder: '3, 5, 8', helpText: 'Costo in Punti Craft. Vuoto = gratis con punti (solo ingredienti). easy=3, medium=5, hard=8' },
    { key: 'pointOnly', label: 'Solo Punti', type: 'boolean', defaultValue: false, helpText: 'Se true, craftabile SOLO con Punti Craft (ignora ingredienti)' },
    { key: 'ngPlusOnly', label: 'Solo NG+', type: 'boolean', defaultValue: false, helpText: 'Se true, disponibile solo dal ciclo NG+ in poi' },
    { key: 'forceMasterQuality', label: 'Qualità Maestra Forzata', type: 'boolean', defaultValue: false, helpText: 'Se true, il risultato è sempre Qualità Maestra ⭐⭐' },
    { key: 'hidden', label: 'Nascosta', type: 'boolean', defaultValue: false, helpText: 'Se true, la ricetta non appare finché non viene scoperta' },
    { key: 'sortOrder', label: 'Ordine', type: 'number', defaultValue: 0 },
  ],
  'avatars': [],
  'start-screen': [],
