...
export const SEED_BANNERS: Record<TabId, SeedBannerConfig | null> = {
  ...
  archetypes:   { icon: Swords,   label: 'Archetipi',   description: 'Gestione <span className="text-white/50 font-medium">archetipi</span> — template di statistiche, abilità e equipaggiamento iniziale per i personaggi giocabili', seedEndpoint: SEED_BASE, seedBody: { section: 'archetypes' } },
  ...
  'enemy-abilities': { icon: Swords, label: 'Abilità Nemici', description: 'Gestione <span className="text-white/50 font-medium">abilità nemici</span> — configura attacchi, potenza, probabilità d\'uso ed effetti di status per i nemici', seedEndpoint: SEED_BASE, seedBody: { section: 'enemy-abilities' } },
