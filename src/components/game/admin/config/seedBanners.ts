...
export const SEED_BANNERS: Record<TabId, SeedBannerConfig | null> = {
  ...
  archetypes:   { icon: Swords,   label: 'Archetipi',   description: 'Gestione <span className="text-white/50 font-medium">archetipi</span> — template di statistiche, abilità e equipaggiamento iniziale per i personaggi giocabili', seedEndpoint: '/api/admin/seed-archetypes' },
  ...
  specials:     { icon: Zap,      label: 'Abilità',    description: 'Gestione <span className="text-white/50 font-medium">abilità personaggi</span> — configura poteri offensivi, difensivi, di supporto e controllo per i personaggi', seedEndpoint: '/api/admin/seed-specials' },
