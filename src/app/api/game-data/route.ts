...
export async function GET() {
  try {
    const [items, events, documents, quests, locations, npcs, characters, specials, enemies, enemyAbilities, secretRooms] = await Promise.all([
    ...
    return NextResponse.json({ items, events, documents, quests, locations, npcs, characters, specials, enemies, enemyAbilities, secretRooms });
  } catch (error) {
