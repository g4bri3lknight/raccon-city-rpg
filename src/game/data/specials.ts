...
export const ALL_SPECIAL_ABILITIES: SpecialAbilityDefinition[] = [
  ...
  },
  {
    id: 'veleno_acido',
    name: 'Veleno Acido',
    description: 'Lancia una sostanza corrosiva che avvelena il nemico. Efficace solo contro bersagli umani.',
    icon: '☣️',
    targetType: 'enemy',
    cooldown: 2,
    category: 'offensive',
  ...
  {
    id: 'ferita_profonda',
    name: 'Ferita Profonda',
    description: 'Un colpo chirurgico che lacera i tessuti del bersaglio causando sanguinamento. efficace solo contro bersagli umani.',
    icon: '🗡️',
    targetType: 'enemy',
    cooldown: 2,
    category: 'offensive',
    executionType: 'ferita_profonda',
    powerMultiplier: 1.2,
    statusToApply: { type: 'bleeding', chance: 65 },
  },
  {
    id: 'lacerazione_multipla',
    name: 'Lacerazione Multipla',
    description: 'Una serie di tagli rapidi che feriscono tutti i nemici causando sanguinamento. Efficace solo contro bersagli umani.',
    icon: '🩸',
    targetType: 'enemy',
    cooldown: 3,
    category: 'offensive',
    executionType: 'lacerazione_multipla',
    powerMultiplier: 0.8,
    statusToApply: { type: 'bleeding', chance: 55 },
  },
  {
    id: 'colpo_tagliente',
    name: 'Colpo Tagliente',
    description: "Un affondo con un'arma affilata che taglia profondamente. Alto danno e probabilità di sanguinamento. Efficace solo contro bersagli umani.",
    icon: '⚔️',
    targetType: 'enemy',
    cooldown: 3,
    category: 'offensive',
    executionType: 'colpo_tagliente',
    powerMultiplier: 1.5,
    statusToApply: { type: 'bleeding', chance: 50 },
  },
  ...
  // ── CONTROL ──
  {
    id: 'gas_venefico',
    name: 'Gas Venefico',
    description: 'Lancia una granata di gas che avvelena tutti i nemici umani e infligge danni moderati.',
    icon: '💨',
    targetType: 'enemy',
    cooldown: 3,
    category: 'control',
  ...
  },
  {
    ...
    description: 'Inietta un siero neurotossico al nemico. Il veleno funziona solo su bersagli umani, lo stordimento su tutti.',
    icon: '🧬',
    targetType: 'enemy',
    cooldown: 3,
    category: 'control',
